...
class Dataset(object):
    ...
    def _genVocabulary(self, reviews, labels):
        ...
        with open("E:/python_workspaces/examp/data/wordJson/word2idx.json", "w", encoding="utf-8") as f:
            json.dump(word2idx, f)

        with open("E:/python_workspaces/examp/data/wordJson/label2idx.json", "w", encoding="utf-8") as f:
    ...
    def _getWordEmbedding(self, words):
        ...
        wordVec = gensim.models.KeyedVectors.load_word2vec_format("E:/python_workspaces/examp/com/isinonet/qb/nlp/word2vector/word2Vec.bin", binary=True)
        vocab = []
        wordEmbedding = []
